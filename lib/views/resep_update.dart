...
import 'package:recipe_app/model/resep.dart';
import 'package:recipe_app/service/resep_service.dart';
import 'package:recipe_app/views/resep_detail.dart';
  ...
  _fieldNama(){
    return TextField(
      decoration: InputDecoration(
        ...
        hintText: 'Masukkan',
        prefixIcon: Icon(Icons.food_bank_rounded, size: 25, color: Color.fromARGB(255, 110, 110, 110)),
  ...
  _fieldImage(){
    return TextField(
      decoration: InputDecoration(
        ...
        hintText: 'Masukkan',
        prefixIcon: Icon(Icons.image_rounded, size: 25, color: Color.fromARGB(255, 110, 110, 110)),
        border: OutlineInputBorder(),
      ),
  ...
  _fieldTime(){
    return TextField(
      decoration: InputDecoration(
        ...
        hintText: 'Masukkan',
        prefixIcon: Icon(Icons.access_time_rounded, size: 25, color: Color.fromARGB(255, 110, 110, 110)),
        border: OutlineInputBorder(),        
      ),
  ...
  _fieldDescription(){
    return TextField(
      decoration: InputDecoration(
        ...
        hintText: 'Masukkan',
        prefixIcon: Icon(Icons.description_rounded, size: 25, color: Color.fromARGB(255, 110, 110, 110)),
        border: OutlineInputBorder(),
      ),
  ...
  _fieldRating(){
    return TextField(
      decoration: InputDecoration(
        ...
        hintText: 'Masukkan',
        prefixIcon: Icon(Icons.star_border_rounded, size: 25, color: Color.fromARGB(255, 110, 110, 110)),
        border: OutlineInputBorder(),        
      ),
  ...
  _fieldIngredient(){
    return TextField(
      decoration: InputDecoration(
        ...
        hintText: 'Masukkan',
        prefixIcon: Icon(Icons.article_rounded, size: 25, color: Color.fromARGB(255, 110, 110, 110)),
        border: OutlineInputBorder(),        
      ),
  ...
  _fieldInstruction(){
    return TextField(
      decoration: InputDecoration(
        ...
        hintText: 'Masukkan',
        prefixIcon: Icon(Icons.integration_instructions_rounded, size: 25, color: Color.fromARGB(255, 110, 110, 110)),
        border: OutlineInputBorder(),
      ),
  ...
  _fieldVideoUrl(){
    return TextField(
      decoration: InputDecoration(
        ...
        hintText: 'Masukkan',
        prefixIcon: Icon(Icons.video_collection_rounded, size: 25, color: Color.fromARGB(255, 110, 110, 110)),
        border: OutlineInputBorder(),
      ),
