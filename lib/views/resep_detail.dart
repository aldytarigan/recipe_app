...
import 'package:recipe_app/views/resep_update.dart';
import 'package:recipe_app/views/video_detail.dart';
...
class _DetailResepState extends State<DetailResep> {
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            ...
            SizedBox(width: 10,),
            Text('ResepKu', style: TextStyle(fontSize: 16),)
          ],
        ),
      ),
      ...
      builder: (context, AsyncSnapshot snapshot) => ElevatedButton(
          onPressed: (){
            Navigator.push(
              ...
              MaterialPageRoute(
                builder: (context)=>
                VideoDetail(resep: snapshot.data)));
          },
          style: ElevatedButton.styleFrom(primary: Colors.green, fixedSize: Size(60, 40)),
      ...
      builder: (context, AsyncSnapshot snapshot) => ElevatedButton(          
          onPressed: (){
            Navigator.push(
              ...
              MaterialPageRoute(
                builder: (context)=>
                ResepUpdate(resep: snapshot.data)));
          },
          style: ElevatedButton.styleFrom(primary: Colors.blue, fixedSize: Size(60, 40)),
  ...
  _tombolhapus(){
    return ElevatedButton(
        ...
        AlertDialog alertDialog = AlertDialog(
          ...
          actions: [
            StreamBuilder(
              ...
              builder: (context, AsyncSnapshot snapshot) => ElevatedButton(
                onPressed: () async {
                  await ResepService().hapus(snapshot.data).then((value) {
      ...
      style: ElevatedButton.styleFrom(primary: Colors.red, fixedSize: Size(60, 40)),
